...
{
    public class WorldGeneratorMultiplicationNormalController: BaseController, IWorldGenerator
    {
        ...
        public WorldGeneratorMultiplicationNormalController(Transform placeFor)
        {
            _placeFor = placeFor;
        ...
        private void WorldGenerator()
        {
            ...
            foreach (var point in _fieldView.Points)
            {
                ...
                pointModel.ItemModels =
                    new ItemModel(LoadItemView(pointModel.PointView.Point1, max1), LoadItemView(pointModel.PointView.Point2, max2), TypeGameEnum.Multiplication);
        ...
        private ItemView LoadItemView(Transform placeFor, int max)
        {
            ...
            item.SetValue(_random.Next(2,max));
