...
{
    public class WorldGeneratorSubtractionNormalController: BaseController, IWorldGenerator
    {
        ...
        public WorldGeneratorSubtractionNormalController(Transform placeFor)
        {
            _placeFor = placeFor;
        ...
        private void WorldGenerator()
        {
            ...
            foreach (var point in _fieldView.Points)
            {
                ...
                var item2 = RandomItem(_random,999 - item1);
