...
{
    public class WorldGeneratorAdditionHardController : BaseController, IWorldGenerator
    {
        ...
        public WorldGeneratorAdditionHardController(Transform placeFor)
        {
            _placeFor = placeFor;
        ...
        private ItemView LoadItemView(Transform placeFor)
        {
            ...
            item.SetValue(_random.Next(2, 100));
